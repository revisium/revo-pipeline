...
const validRootSource =
  ...
  "export type { ActivateDecision, ActivationCause, AllJoinPolicy, AnyJoinPolicy, BranchCase, BranchDefault, BranchName, BranchNode, BranchPredicate, CandidateKey, CandidateVerdict, CompiledEdge, CompiledEdgeIndexEntry, CompiledEdgeRole, CompiledForkBranch, CompiledForkRegion, CompiledNode, CompiledNodeIndexEntry, CompiledPipeline, ConsensusNode, ConsensusOutcome, ConsensusPolicy, ConsensusRoutes, ExecutorRequirement, FactDefinition, FactKey, FactType, ForkBranch, ForkNode, GateResolution, HumanGateNode, HumanGateRoute, JoinNode, JoinOutcome, JoinPolicy, JoinRoutes, JsonScalar, JsonValue, NodeFact, NodeKey, NoopDecision, PipelineDefinition, PipelineExecutionTemplate, PipelineFacts, PipelineNode, PipelineCandidateVerdictRecord, PipelineCommand, PipelineCommandApplication, PipelineEffect, PipelineEffectBatch, PipelineForkRelation, PipelineGateResolutionRecord, PipelineNodeOccurrence, PipelineOccurrenceKey, PipelineReductionStatus, PipelineRetirement, PipelineSnapshot, PipelineSnapshotNode, PipelineTerminal, PipelineValueRecord, PipelineValueSource, PipelineWait, PipelineValueFact, QuorumConsensusPolicy, ResolutionName, ScriptIdentity, ScriptNode, SelectDecision, TaskNode, TaskOutcome, TaskRoutes, TerminalBindingTemplate, TerminalDecision, TerminalNode, ThresholdConsensusPolicy, ThresholdJoinPolicy, UnanimousConsensusPolicy, WaitDecision, WaitReason } from './spec/index.js';\n" +
  "export type { CompiledPipelineDecoding, DecodeFault, DecodeFaultCode, DecisionFault, DecisionFaultCode, DefinitionFault, DefinitionFaultCode, PipelineCompilation, PipelineDecision, PipelineReduction, PipelineReductionFault, PipelineReductionFaultCode, RejectDecision } from './errors/index.js';\n";
